...
public class ModEntity {
    ...
    public static final RegistryObject<EntityType<SCP939>> SCP_939 = register("scp_939", EntityType.Builder.of(SCP939::new, MobCategory.MONSTER).sized(1.3f, 1f));
    ...
    public static final RegistryObject<EntityType<SCP2521>> SCP_2521 = register("scp_2521", EntityType.Builder.of(SCP2521::new, MobCategory.MONSTER));
    public static final RegistryObject<EntityType<SCP131>> SCP_131 = register("scp_131", EntityType.Builder.of(SCP131::new, MobCategory.CREATURE));
