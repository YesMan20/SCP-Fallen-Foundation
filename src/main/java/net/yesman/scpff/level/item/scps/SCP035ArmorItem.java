...
public class SCP035ArmorItem extends SCPArmorItem {
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        ...
        player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1000000, 1));
        player.addEffect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 1000000, 13));
        player.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1000000, 5));
        player.addEffect(new MobEffectInstance(MobEffects.WITHER, 1000000, 2));
    }
