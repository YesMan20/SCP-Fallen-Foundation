...
public enum FFArmorMaterialsRegistry implements ArmorMaterial {
    ...
    RESEARCHER_SUIT("researcher_suit", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 1);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 2);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 3);
    }), 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
    ...
    private FFArmorMaterialsRegistry(String p_268171_, int p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
